...
class List { //Setiap elemennya unik
	...
	public:
		...
		void add(Type); //menambah ke depan
		template <class Type2>
		void add(Type2); //menambah ke depan (demi polymorphism)
		...
		void removeIValue(); //remove elemen iterator
		bool atEnd() const; //menandakan apakah sudah sampai akhir list
};
